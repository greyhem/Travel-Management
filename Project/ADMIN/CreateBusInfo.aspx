<%@ Page Language="C#" MasterPageFile="~/ADMIN/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreateBusInfo.aspx.cs" Inherits="ADMIN_CreateBusInfo" Title="Untitled Page" %>
        ...
        <tr>
            <td align="center">
                <table cellpadding="0" cellspacing="5" align="center" class="border1" width="50%">
                    <tr>
                        <td colspan="2" align="center">
                            <span style="font-size: 12pt"><span style="color: maroon"><b><span style="color: darkred;">
                                <em>
                                Bus Information Registration</em></span></b> </span></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">
                            <font color="red">*</font><b>BusType :</b>
                        </td>
                        <td align="left">
                            <asp:DropDownList ID="ddlBusType" runat="server" Width="128px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlSource" runat="server" Width="128px">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="ddlDestination" runat="server" Width="128px">
                    ...
                    <tr>
                        <td align="right">
                            <font color="red">*</font><b>NoOfSeatsAvailable :</b>
                        </td>
                        <td align="left">
                     ...
                     <tr>
                        <td align="right">
                            <font color="red">*</font><b>Bus Starting Time :</b>
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtTime" runat="server" CssClass="textbox" Height="16px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                    ...
                    <tr>
                        <td align="center" >
                         ...
                         <td align="left" >
                             <asp:Button ID="Button1" runat="server" Text="Provide Service" CssClass="button"
                                OnClientClick="return Validation(this);" OnClick="Button1_Click" />
