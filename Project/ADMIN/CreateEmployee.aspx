<%@ Page Language="C#" MasterPageFile="~/ADMIN/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreateEmployee.aspx.cs" Inherits="ADMIN_CreateEmployee" Title="Untitled Page" %>
    ...
    <table cellpadding="0" cellspacing="5" align="center" class="border1" width="50%">
        <tr>
            <td colspan="2" align="center">
                <span style="font-size: 12pt"><span style="color: maroon"><b><span style="color: darkred;">
                    <em>Creation Of Employee Information </em></span></b></span></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" width="30%" >
                <font color="red">*</font><b>EmployeeName :</b>
            </td>
        ...
        <tr>
            ...
            <td align="left" colspan="2" style="height: 43px">
        ...
        <tr>
            <td align="right" >
                <font color="red">*</font><b>AllotedToBranch :</b>
            </td>
        ...
        <tr>
            ...
            <td align="left">
                 <asp:Button ID="Button1" runat="server" Text="Create Employee" CssClass="button"
                    OnClientClick="return Validation(this);" OnClick="Button1_Click" />
                <asp:Button ID="brnBack" runat="server" Text="Back" CssClass="button" OnClick="brnBack_Click" />
            </td>
        </tr>
        <tr>
            <td align="left" colspan="2">
