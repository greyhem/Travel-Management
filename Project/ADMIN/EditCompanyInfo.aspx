<%@ Page Language="C#" MasterPageFile="~/ADMIN/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditCompanyInfo.aspx.cs" Inherits="ADMIN_EditCompanyInfo" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="5" align="center" class="border1" width="50%">
        <tr>
            <td colspan="2" align="center">
                <span style="font-size: 12pt"><span style="color: maroon"><b><span style="color: darkred;">
                    <em>Company Details</em></span></b> </span></span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right">
                <font color="red">*</font><b>Company Name :</b>
            </td>
