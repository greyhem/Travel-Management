<%@ Page Language="C#" MasterPageFile="~/ADMIN/MasterPage.master" AutoEventWireup="true" CodeFile="MaintainUsers.aspx.cs" Inherits="ADMIN_MaintainUsers" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <script type="text/javascript" language="javascript">
        ...
        <script type="text/javascript">
         ...
         {
            var rowCount=<%=dgUsers.Items.Count %>;
            var intLoop;
		    var intIndex=2;
		    var Count=0;
		    for(intLoop=0;intLoop<rowCount;intLoop++)
		    {
		        if(intIndex<10)
		        {            
                    if(document.getElementById("ctl00_ContentPlaceHolder1_dgUsers_ctl0"+intIndex+"_chkDel").checked==true)                    
                    {  
                        Count=Count+1;       
                    } 
                }
                ...
                {
                    if(document.getElementById("ctl00_ContentPlaceHolder1_dgUsers_ctl"+intIndex+"_chkDel").checked==true)
                    {
                        Count=Count+1;
                    }
                } 
  ...
  <table cellpadding="0" cellspacing="0" width="90%" align="center">
        <tr>
            <td align="left" >
                <b style="font-size: small;">User Details</b>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:DataGrid ID="dgUsers" runat="server" DataKeyField="UserID"
                    Width="100%" AutoGenerateColumns="False" OnItemCommand="dgUsers_ItemCommand" CellPadding="4" ForeColor="#333333" GridLines="None"  >
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Address" HeaderText="Address"></asp:BoundColumn>
                           <asp:TemplateColumn>
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkView" runat="server" CommandName="Edit" CssClass="bluelinks">View User</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                    </Columns>
