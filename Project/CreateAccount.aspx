<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CreateAccount.aspx.cs" Inherits="USERS_CreateAccount" Title="Untitled Page" %>
                    ...
                    <WizardSteps>
                        <asp:WizardStep ID="WizardStep1" runat="server" Title="Step 1" AllowReturn="False"
                            ...
                            <table cellpadding="0" cellspacing="6" align="center" width="100%" >
                                    ...
                                    <td colspan="2">
                                        <table id="tblAccountDetails" runat="server" cellpadding="0" cellspacing="5" width="100%">
                                            <tr id="Tr1" runat="server">
                                                <td id="Td1" colspan="2" align="center" style="height: 25px;" runat="server">
                                                    ...
                                                    <span style="font-size: 12pt"><span style="color: maroon"><b><span style="color: darkred;">
                                                        <em>User Registration Form</em></span></b> </span></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            <td>
                                            ...
                                            <tr id="Tr2" runat="server">
                                                <td id="Td2" align="right" width="27%" runat="server">
                                                    <font color="red">*</font><span class="boldtxt">User Name:</span>
                                                </td>
                                            ...
                                            <tr id="Tr3" runat="server">
                                                <td id="Td4" align="right" runat="server">
                                                   <font color="red">*</font><span class="boldtxt">Password:</span>
                                                </td>
                                            ...
                                            <tr id="Tr4" runat="server">
                                                <td id="Td6" align="right" runat="server">
                                                   <font color="red">*</font><span class="boldtxt">Confirm Password:</span>
                                                </td>
                                ...
                                <tr>
                                    <td colspan="2" align="left" style="height: 25px;" width="27%">
                                        <%--<u><b><span class="heading">Contact Details</span></b></u>--%>
                                         <span style="font-size: 12pt"><span style="color: maroon"><b><span style="color: darkred;">
                                                        <em>Contact Details</em></span></b> </span></span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right">
                                        <font color="red">*</font><span class="boldtxt">Country:</span>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    <td align="right">
                                        <font color="red">&nbsp;*</font><span class="boldtxt">City:</span>
                                    </td>
                                    <td align="left">
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:Button ID="btnSave" runat="server" Text="Save And Proceed" CssClass="button"
