        ...
        <tr>
            <td align="center">
                ...
                <table id="tblSearch" cellpadding="0" cellspacing="5" align="center" class="border1"
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <asp:DataGrid ID="dgSearchResults" runat="server" BorderWidth="0px" Width="100%"
                                AutoGenerateColumns="False" CssClass="gridheader">
                                <HeaderStyle HorizontalAlign="Center" Height="20px" CssClass="gridheader"></HeaderStyle>
                                <Columns >
